...
<div class="all_student fix">
		...
		function credit_hour($x){
			if($x=="DBMS") return 3;
			elseif($x == "SIT 411") return 1;
			elseif($x == "SIT 412") return 4;
			elseif($x == "Programming") return 3;
			elseif($x == "SIT 414") return 1;
			elseif($x == "SIT 415") return 4;
			elseif($x == "SIT 416") return 3;
			elseif($x == "SIT 413") return 3;
			elseif($x == "SIT 417") return 3;
		}
